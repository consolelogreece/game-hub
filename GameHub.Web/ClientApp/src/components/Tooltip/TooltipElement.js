...
export default class TooltipElement extends React.PureComponent
{
    componentDidMount()
    {
        ...
        setTimeout(() => {this.props.scheduleUpdate()}, this.props.parentTransitionPeriod);
    }
    render()
    {
        return (
            <div ref={this.props.tooltipref} id="tooltip-pop-element-body" className={this.props.renderSpecificClass} style={{...this.props.style, }} data-placement={this.props.placement}>
                {this.props.tooltip}
